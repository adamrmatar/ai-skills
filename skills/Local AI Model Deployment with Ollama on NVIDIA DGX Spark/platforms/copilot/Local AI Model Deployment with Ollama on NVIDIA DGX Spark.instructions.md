# Copilot Instructions: Local Ai Model Deployment With Ollama On Nvidia Dgx Spark
Description: Skill for deploying and running local AI models using Ollama on NVIDIA DGX Spark hardware, including model download, inference execution, and integration with coding tools like Claude.
