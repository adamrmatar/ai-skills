# Copilot Instructions: Handoff Skill
Description: The Handoff Skill enables an AI agent to compact the current conversation into a handoff document for another agent to pick up. This ensures seamless continuation of work across different agent sessions.
