# Copilot Instructions: Claude Design Automation
Description: A systematic approach to generating brand-aligned design assets in Claude Design by pre-establishing design systems, templates, and copy through skills to minimize iterations and token usage.
...
1. Gather all brand assets (logos in multiple formats, color codes, font files)
2. Collect examples of existing designs (website screenshots, slide decks, social media posts)
3. Use the Design System Creator skill to:
   - Scrape your website for design elements
   - Organize assets into a structured folder
   - Generate Claude Design system prompts
4. Upload the complete folder to Claude Design
5. Test the system by generating sample assets
...
1. Identify repetitive design use cases (slide decks, social posts, etc.)
2. Collect layout inspirations from:
   - Gamma (for slides)
   - Dribbble/Behance (for UI/UX)
   - Framer (for websites)
3. Feed examples to Claude Design with instruction:
   "Recreate these layouts in HTML using our brand design system. Use placeholders for content."
4. Refine through 2-3 iterations
5. Save as template via Share > Duplicate as Template