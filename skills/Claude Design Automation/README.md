...
### 💻 Antigravity
_Copy the contents of `platforms/antigravity/` to `~/.gemini/config/skills/Claude Design Automation/`._

### 💻 Cursor
_Copy `platforms/cursor/Claude Design Automation.mdc` to your project's `.cursor/rules/` directory._

### 💻 Claude
_Append the contents of `platforms/claude/CLAUDE.md` to the target project's `CLAUDE.md` file._

### 💻 Copilot
_Copy `platforms/copilot/Claude Design Automation.instructions.md` to your project's `.github/instructions/` directory._
